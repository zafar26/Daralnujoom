...
export default function UniformSharjah() {
  return (
    <>
      <NextSeo
        title="Uniforms in Sharjah | Tailoring | Dar Al Nujom"
        description="uniforms bulk stitching orders. Get a free quote today."
        canonical="https://daralnujom.shop/uniforms-sharjah"
        openGraph={{
          title: 'Uniforms in Sharjah | Dar Al Nujom',
          description: 'Expert stitching for all uniform types and party wear. Bulk orders from 50 to 10,000 pieces.',
          url: 'https://daralnujom.shop/uniforms-sharjah',
        }}
      />
      <Layout>
        {/* Page Header */}
        <section style={{
          ...
          <div style={{
            ...
            <div>
                <h1> Uniforms in Sharjah</h1>

                <p> We supply uniforms across Sharjah</p>
            </div>
