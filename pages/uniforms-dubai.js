...
export default function UniformDubai() {
  return (
    <>
      <NextSeo
        title="Uniforms in Dubai | Tailoring | Dar Al Nujom"
        description="uniforms bulk stitching orders. Get a free quote today."
        canonical="https://daralnujom.shop/uniforms-dubai"
        openGraph={{
          title: 'Uniforms in Dubai | Dar Al Nujom',
          description: 'Expert stitching for all uniform types and party wear. Bulk orders from 50 to 10,000 pieces.',
          url: 'https://daralnujom.shop/uniforms-dubai',
        }}
      />
      <Layout>
        {/* Page Header */}
        <section style={{
          ...
          <div style={{
            ...
            <div>
                <h1> Uniforms in Dubai</h1>

                <p> We supply uniforms across Dubai</p>
            </div>
