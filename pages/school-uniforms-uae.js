...
const items = [
  { id: 1, state: 'Dubai', emoji: '🏙️', label: 'School Uniform in Dubai', color: '#1E3A5F', url: '/school-uniforms-dubai' },
  { id: 2, state: 'Sharjah', emoji: '🕌', label: 'School Uniform in Sharjah', color: '#2D1A0A', url: '/school-uniforms-sharjah' },
  { id: 3, state: 'Ajman', emoji: '🌊', label: 'School Uniform in Ajman', color: '#0A2010', url: '/school-uniforms-ajman' },
  { id: 4, state: 'Ras Al Khaimah', emoji: '🏔️', label: 'School Uniform in Ras Al Khaimah', color: '#2D0A1A', url: '/school-uniforms-ras-al-khaimah' },
];
